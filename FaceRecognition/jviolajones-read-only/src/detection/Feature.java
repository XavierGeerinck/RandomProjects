	...
	public int getLeftOrRight(int[][] grayImage, int[][] squares, int i, int j, float scale) {
		...
		vnorm=(vnorm>1)?Math.sqrt(vnorm):1;
				...
				for(int k=0;k<nb_rects;k++)
				{
                    ...
                    if (rx1 == 23 && rx2 == 26 && ry1 == 427 && ry2 == 434) {
                        System.out.println("X1: " + rx1);
                        System.out.println("X2: " + rx2);
                        System.out.println("Y1: " + ry1);
                        System.out.println("Y2: " + ry2);
                        System.out.println("Rect Sum: " + (int)((grayImage[rx2][ry2]-grayImage[rx1][ry2]-grayImage[rx2][ry1]+grayImage[rx1][ry1])*r.weight));
                    }
